...
module.exports = Object.freeze({
  ...
  alreadyVerified: {
    en: "User's email is already verified",
    ar: "تم التحقق من بريد المستخدم مسبقًا",
  },
  unsupportedLanguage: {
  ...
  unsupportedReceiverType: {
    en: "Receiver is not supported, we can send the code only to your email",
    ar: "مكان الاستقبال غير مدعوم، يمكننا إرسال الرمز إلى بريدك الإلكتروني",
  },
  notUpdated: {
  ...
  paymentUnverified: {
    ...
    ar: "تم تقييد حسابك، يرجى التواصل مع الدعم",
  },
});
