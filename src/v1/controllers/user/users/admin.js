...
module.exports.changeUserRole = async (req, res, next) => {
  try {
    ...
    const updatedUser = await usersService.changeUserRole(email, role);
...
module.exports.verifyUser = async (req, res, next) => {
  try {
    ...
    const updatedUser = await usersService.verifyUser(email);
...
module.exports.findUserByEmail = async (req, res, next) => {
  try {
    ...
    // Asking service to find a user by its email
    // with a specific role
    const user = await usersService.findUserByEmail(email, role, true);
