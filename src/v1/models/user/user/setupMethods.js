...
module.exports = (mongodbSchema) => {
  ...
  mongodbSchema.methods.isPaymentVerified = function () {
    return this.verified.payment;
  };

  mongodbSchema.methods.verifyPayment = function () {
    this.verified.payment = true;
  };

  mongodbSchema.methods.unverifyPayment = function () {
    this.verified.payment = false;
  };
};
